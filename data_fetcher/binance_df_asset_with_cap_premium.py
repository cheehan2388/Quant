...
data = "premiumIndexKlines"
# ────── 基本參數 ────────────────────────────────────────────────────────────────
API_ENDPOINT = "https://fapi.binance.com//fapi/v1/premiumIndexKlines"
OUTPUT_DIR   = "./../Data"              # 依需求修改
LIMIT        = 1500                     # Binance 最大值
SYMBOLS      = ["BTC", "ETH", "BNB", "LINK", "AVAX",
                "XRP", "DOGE", "SUI", "BCH", "SOL"]
INTERVALS    = [ "1h"]             # 想加別的就放進來

START_TIME   = datetime(2020, 5, 11, tzinfo=timezone.utc)
END_TIME     = datetime(2025, 8, 3, tzinfo=timezone.utc)
